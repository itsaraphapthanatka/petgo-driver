...
const resources = {
    en: {
        translation: {
            ...
            register_screen: {
                ...
                subtitle: "Register to start receiving pet transport jobs",
                full_name: "Full Name *",
                ...
                otp_sent: "OTP Sent",
                otp_sent_desc: "OTP sent to {{phone}}",
                dev_otp: "Dev OTP: {{otp}}",
                ...
                vehicle_plate_placeholder: "e.g. 1กก 1234",
                agree_prefix: "By signing up, you agree to our",
                terms: "Terms of Service",
                and: "and",
                privacy: "Privacy Policy",
                sign_up: "Sign Up as Driver",
                already_have_account: "Already have an account?",
                login: "Login",
                error_required_fields: "Please fill in all required fields",
                error_invalid_phone: "Invalid Thai phone number. Use 0812345678 or +66812345678",
                error_invalid_email: "Invalid email address",
                error_password_length: "Password must be at least 6 characters",
                error_otp_required: "Please request the OTP and enter the 6-digit code",
                error_agree_terms: "Please agree to the Terms of Service and Privacy Policy",
                register_failed: "Registration Failed",
                register_failed_desc: "Could not create account",
            },
    ...
    th: {
        translation: {
            ...
            // Register (driver)
            register_screen: {
                title: "สร้างบัญชีคนขับ",
                subtitle: "สมัครเพื่อเริ่มรับงานขนส่งสัตว์เลี้ยง",
                full_name: "ชื่อ-นามสกุล *",
                full_name_placeholder: "สมชาย ใจดี",
                phone: "เบอร์โทรศัพท์ *",
                phone_placeholder: "0812345678",
                send_otp: "ส่งรหัส OTP",
                resend_otp: "ส่งรหัสอีกครั้ง",
                otp: "รหัส OTP *",
                otp_placeholder: "กรอกรหัส 6 หลัก",
                otp_sent: "ส่งรหัส OTP แล้ว",
                otp_sent_desc: "ส่งรหัส OTP ไปที่ {{phone}} แล้ว",
                dev_otp: "รหัส OTP (dev): {{otp}}",
                otp_request_failed: "ส่งรหัส OTP ไม่สำเร็จ",
                email_optional: "อีเมล (ไม่บังคับ)",
                email_placeholder: "email@example.com",
                password: "รหัสผ่าน *",
                vehicle_type: "ประเภทรถ *",
                vehicle_plate: "ทะเบียนรถ *",
                vehicle_plate_placeholder: "เช่น 1กก 1234",
                agree_prefix: "การสมัครถือว่าคุณยอมรับ",
                terms: "ข้อกำหนดการใช้บริการ",
                and: "และ",
                privacy: "นโยบายความเป็นส่วนตัว",
                sign_up: "สมัครเป็นคนขับ",
                already_have_account: "มีบัญชีอยู่แล้ว?",
                login: "เข้าสู่ระบบ",
                error_required_fields: "กรุณากรอกข้อมูลที่จำเป็นให้ครบ",
                error_invalid_phone: "เบอร์โทรศัพท์ไม่ถูกต้อง ใช้รูปแบบ 0812345678 หรือ +66812345678",
                error_invalid_email: "อีเมลไม่ถูกต้อง",
                error_password_length: "รหัสผ่านต้องมีอย่างน้อย 6 ตัวอักษร",
                error_otp_required: "กรุณาขอรหัส OTP และกรอกรหัส 6 หลัก",
                error_agree_terms: "กรุณายอมรับข้อกำหนดการใช้บริการและนโยบายความเป็นส่วนตัว",
                register_failed: "สมัครไม่สำเร็จ",
                register_failed_desc: "ไม่สามารถสร้างบัญชีได้",
            },
